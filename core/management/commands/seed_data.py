...
class Command(BaseCommand):
    ...
    def create_leaders(self):
        leader_data = [
            ...
            ('secretary', 'secretary', 'secretary@kenyakorea.com', 'Peter', 'Kamau', 'Community Secretary',
             'Peter manages community records, documentation, and member verification. He keeps our community organized and informed.'),
